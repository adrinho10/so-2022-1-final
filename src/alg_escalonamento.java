...
public class alg_escalonamento {
    ...
    public static void main(String[] args) {
        ...
        while(true) {
            System.out.print("[Escolha o argoritmo?: 1=FCFS 2=SJF Preemptivo 3=SJF Não Preemptivo 4=Prioridade não preemptivo \n" +
                    " 5=Prioridade preemptivo 6=Round Robb]: 7 = Imprime conteudo Inicial dos processos 8 = Retribui valores iniciais 9 = Sair ");
            alg =  teclado.nextInt();
